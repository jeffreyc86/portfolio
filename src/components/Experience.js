        ...
        <div className="container experience-wrapper">
          <div className="timeline-block timeline-block-left">
            ...
            <div className="timeline-content">
              ...
              <p>
                ...
                jQuery. Improved the overall UX for visitors of the resources library; specifically domestic abuse victims in search of
          ...
          <div className="timeline-block timeline-block-left">
            ...
            <div className="timeline-content">
              ...
              <span className="dates-employed">
                April 2019 - September 2020
              </span>
              <p>
                Drove growth via outbound outreach. Called on C-Suite
                executives, General Counsels, and potential clients, to identify
                potential engagements for Factor’s next-generation legal
                solutions focused around process, workflow software, and
          ...
          <div className="timeline-block timeline-block-right">
            ...
            <div className="timeline-content">
              ...
              <p>
                Cultivated relationships with interior design firms within
                eastern Canada, New York, and Washington DC. Developed
                customized account plans and achieved $1 million in sales within
          ...
          <div className="timeline-block timeline-block-left">
            ...
            <div className="timeline-content">
              ...
              <p>
                ...
                in 2016, 2017, and first half of 2018, while overseeing a team
                of three Account Executives.
              </p>
            </div>
          </div>
        </div>
