    ...
    return (
        <div id="experience" className="experience">
            <div className="d-flex justify-content-center my-4">
                <h1>Where I've Worked<span id="exp-overlap">Where I've Worked</span></h1>
            </div>
            <div className="container experience-wrapper">
                <div className="timeline-block timeline-block-left">
                    ...
                    <div className="timeline-content">
                        ...
                        <h6 className="employer">@ <a href="https://flatironschool.com/" target="_blank" rel="noreferrer">Flatiron School</a></h6>
                ...
                <div className="timeline-block timeline-block-right">
                    ...
                    <div className="timeline-content">
                        ...
                        <h6 className="employer">@ <a href="http://factor.law/" target="_blank" rel="noreferrer">Factor</a></h6>
                ...
                <div className="timeline-block timeline-block-left">
                    ...
                    <div className="timeline-content">
                        ...
                        <h6 className="employer">@ <a href="http://www.liaigre.com/en/" target="_blank" rel="noreferrer">Liaigre, Inc</a></h6>
                ...
                <div className="timeline-block timeline-block-right">
                    ...
                    <div className="timeline-content">
                        ...
                        <h6 className="employer">@ <a href="https://www.cassina.com/it/en.html" target="_blank" rel="noreferrer">Cassina</a></h6>
